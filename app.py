...
# =============================================================================
# SESSION STATE INITIALIZATION & RESET FUNCTIONS
# =============================================================================
...
def render_sidebar_controls():
    ...
    with st.sidebar.expander("Duotone Filter", expanded=True):
        ...
        st.button("Reset Duotone", on_click=reset_duotone_controls, width="stretch")
    ...
    with st.sidebar.expander("Image Adjustments"):
        ...
        st.button("Reset Adjustments", on_click=reset_image_adjustments, width="stretch")
    ...
    with st.sidebar.expander("Advanced Color Grading"):
        ...
        st.button("Reset Color Grading", on_click=reset_advanced_color_grading, width="stretch")
    ...
    with st.sidebar.expander("Stylistic Effects"):
        ...
        st.button("Reset Stylistic", on_click=reset_stylistic_effects, width="stretch")
...
def render_transform_controls():
    ...
    flip_horizontal = col1.button("Flip Horizontal", width="stretch")
    flip_vertical = col2.button("Flip Vertical", width="stretch")
...
def main():
    ...
    # File upload with HEIC/HEIF support
    ...
    if uploaded_file is not None:
        ...
        if original_image:  # Check if loading was successful
            ...
            # Aggressive resizing happens immediately after loading
